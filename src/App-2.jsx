...
import { CLIENTS, TRAINING_MATERIALS, visibleClients } from './clients.js';
import './theme.css';
...
export default function App() {
  ...
  async function handleSignIn(e) {
    ...
    if (email.trim().toLowerCase() === SUPER_ADMIN_EMAIL) {
      setSession({ isSuperAdmin: true, client: null, email: email.trim().toLowerCase() });
    ...
    try {
      ...
      setSession({ ...result, isSuperAdmin: false, email: email.trim().toLowerCase() });
      ...
      <div className="lp-shell">
        <div className="lp-card" style={{ width: 820 }}>
          <div className="lp-nav">
            ...
            <a className="lp-tag lp-tag-outline" style={{ marginLeft: 'auto', textDecoration: 'none' }} href="/reports/schedule.html">Execution calendar</a>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
            {visibleClients(session && session.email).map(c => (

...
## 4. Backfilling the last 3 months of data
...
## 6. Testing the PWA with real users
...
4. Have a handful of real reps use it for a week on their own phones (check-in/out, tasks, Leegra Learning) before wider rollout — this is the cheapest way to catch UX issues before committing to app-store packaging.

## 7. Next step once it's proven: Apple App Store & Google Play
